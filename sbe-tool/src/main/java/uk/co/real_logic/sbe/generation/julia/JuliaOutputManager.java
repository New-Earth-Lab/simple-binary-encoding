...
/**
 * {@link OutputManager} for managing the creation of julia source files as the target of code generation.
 * The character encoding for the {@link java.io.Writer} is UTF-8.
 */
public class JuliaOutputManager implements OutputManager
{
    private final File outputDir;

    /**
     * Create a new {@link OutputManager} for generating julia source files into a given package.
     *
     ...
     */
    public JuliaOutputManager(final String baseDirName, final String namespaceName)
    {
    ...
    /**
     * Create a new output which will be a Julia source file in the given package.
     * <p>
     ...
     *
     * @param name the name of the Julia struct.
    ...
    {
        final File targetFile = new File(outputDir, name + ".jl");
